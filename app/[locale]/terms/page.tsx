...
const content: Partial<Record<Locale, Content>> = {
  ko: {
    ...
    sections: [
      ...
      { icon: ShieldCheck, title: '4. 분석 및 광고 정책', text: '서비스 이용 현황을 파악하기 위해 Google Analytics 4를 사용할 수 있습니다. 필요한 환경 설정과 동의 준비가 완료된 경우 Google AdSense 광고를 표시할 수 있습니다. 외부 팝업 광고, 다운로드 광고 게이트 및 광고 차단 감지는 사용하지 않습니다. 자세한 처리 기준은 개인정보처리방침을 따릅니다.' },
  ...
  ja: {
    ...
    sections: [
      ...
      { icon: ShieldCheck, title: '4. 分析・広告方針', text: '利用状況を把握するためGoogle Analytics 4を使用する場合があります。必要な設定と同意準備が整っている場合、Google AdSense広告を表示することがあります。外部ポップアップ広告、ダウンロード時の広告ゲート、広告ブロック検知は使用しません。詳細はプライバシーポリシーをご確認ください。' },
