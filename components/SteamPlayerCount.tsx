...
export default async function SteamPlayerCount({ steamAppId, locale }: SteamPlayerCountProps) {
  ...
  return (
    <div className="flex items-center gap-2 px-3 py-1.5 bg-slate-900/50 border border-emerald-500/20 rounded-full shadow-[0_0_10px_rgba(16,185,129,0.1)] w-fit my-2">
